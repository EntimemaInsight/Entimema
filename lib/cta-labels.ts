/**
 * Entimema CTA architecture:
 * - commercial conversion: use the shared primary label below;
 * - general consulting or business problems: use the shared conversation label below;
 * - exploration and content: keep wording contextual to the destination;
