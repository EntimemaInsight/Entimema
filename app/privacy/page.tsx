    ...
    <main className={styles.page}>
      ...
      <div className={styles.noticeLayout}>
        ...
        <article className={styles.notice}>
          <section id="scope"><p className={styles.number}>01</p><h2>Scope</h2><p>The controller of personal data is <strong>ENTIMEMA EDPK</strong>, a single-member variable capital company incorporated under Bulgarian law, registered under UIC <strong>208447293</strong>.</p><p><strong>Registered office:</strong> 117 General Danail Nikolaev Street, Floor 3, Apartment 8, Tsentralen District, 4002 Plovdiv, Bulgaria.</p><p>This notice applies to personal data processed through Entimema’s public website, inquiry forms and direct business communications. It does not describe customer-document processing inside a product workflow; see <Link href="/security">Security &amp; Trust</Link> for the current workflow assurance scope.</p></section>
          ...
          <section id="contact"><p className={styles.number}>07</p><h2>Privacy contact and updates</h2><p>To ask a privacy question or exercise a data-subject right, contact ENTIMEMA EDPK at <a href="mailto:office@entimema.com">office@entimema.com</a>.</p><p>This notice may be updated when website processing, providers or applicable requirements change. The current version is published on this page.</p><div className={styles.securityLink}><span>Product assurance</span><p>For data handling, scope boundaries and human review in the current Financial Intelligence workflow, read our security overview.</p><Link href="/security">Read Security &amp; Trust <span aria-hidden="true">→</span></Link></div></section>
        </article>
      </div>
    </main>
  );
