    ...
    <main className={styles.page}>
      ...
      <article className={styles.article}>
        ...
        <div className={styles.content}>
          ...
          <section aria-labelledby="analytics-title"><h2 id="analytics-title">Optional website analytics</h2><p>Where analytics is enabled, Entimema uses Google Analytics only after you choose to allow it. The purpose is to understand broad acquisition sources, landing pages, Resource engagement, transitions to relevant services and successfully submitted inquiries.</p><p>Analytics events do not include your name, email address, company, message or other Contact-form contents. Google Analytics may use browser identifiers and analytics cookies after consent. Advertising storage, Google signals and ad-personalisation features are disabled in the website implementation.</p><p>Your choice is stored in your browser. You can decline analytics or review your preference at any time. Retention and other account-level settings must be confirmed by the site owner before activation.</p><AnalyticsPreferencesButton className={styles.preferencesButton} /></section>
