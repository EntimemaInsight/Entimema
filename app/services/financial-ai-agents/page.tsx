...
const capabilities = [
  ["Reporting Agents", "Автоматично генериране и публикуване на управленска отчетност."],
  ["Planning Agents", "Подготовка и актуализация на бюджети, прогнози и сценарии."],
  ["Controlling Agents", "Автоматичен анализ на отклоненията и финансовите резултати."],
  ["ERP Agents", "AI агенти, които работят с ERP данните и автоматизират повтаряемите операции."],
  ["Decision Support", "AI помощници за финансов анализ и управленски решения."],
  ["Workflow Automation", "AI агенти, които изпълняват финансови работни потоци от край до край."],
];
const process = [
    ...
    <main className={styles.page}>
      ...
      <section className={styles.hero} aria-labelledby="financial-ai-agents-title"><div className={`site-container ${styles.heroInner}`}>
        <div className={styles.heroCopy}>
          ...
          <Link className={styles.primaryButton} href="/contact">Обсъдете финансовите си процеси <span aria-hidden="true">→</span></Link>
      ...
      <section className={styles.ctaSection} aria-labelledby="cta-title"><div className="site-container"><div className={styles.ctaBlock}><span>AI автоматизация на финансовите операции</span><h2 id="cta-title">Изградете дигитални финансови служители около реалните процеси на бизнеса.</h2><p>Започваме с конкретните повтаряеми задачи, системите и контролните точки, които определят надеждното изпълнение.</p><Link className={styles.ctaButton} href="/contact">Обсъдете възможностите <span aria-hidden="true">→</span></Link></div></div></section>
    </main>
  );
}
