...
const capabilities = [
  ...
  ["Executive Dashboard", "Информация за ръководството, организирана около решенията, а не около счетоводните отчети."],
  ...
  ["Reporting Framework", "Стандартизирани отчети, ритъм на публикуване и единна структура на информацията."],
...
const process = [
  ...
  ["03", "Внедряване", "Изграждаме dashboard-и, отчети и автоматизирани процеси за актуализация."],
    ...
    <main className={styles.page}>
      ...
      <section className={styles.hero} aria-labelledby="management-reporting-title"><div className={`site-container ${styles.heroInner}`}>
        <div className={styles.heroCopy}>
          ...
          <Link className={styles.primaryButton} href="/contact">Обсъдете управленската си отчетност <span aria-hidden="true">→</span></Link>
        </div>
        <ManagementDashboard />
      </div></section>
