...
const metrics = [
  ...
  ["Gross Margin", "42.8%", "Stable this quarter"],
];

export default function CfoDashboard() {
  return (
    <div className={styles.dashboard} aria-label="Демонстрационен финансов dashboard">
      ...
      <div className={styles.charts}>
        <section className={styles.chartPanel} aria-labelledby="forecast-chart-title">
          ...
          <svg className={styles.lineChart} viewBox="0 0 420 150" role="img" aria-label="Actual стойностите завършват малко над прогнозата">
        ...
        <section className={styles.cashPanel} aria-labelledby="cash-chart-title">
          <div className={styles.chartHeading}><div><span>Liquidity</span><h3 id="cash-chart-title">Cash Flow Outlook</h3></div></div>
