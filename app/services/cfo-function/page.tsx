...
const useCases = [
  ["Растящи компании", "За бизнеси, които са надраснали базовото счетоводно управление, но все още нямат пълна CFO структура."],
  ["Производство", "За организации с комплексна себестойност, материални потоци, инвестиции и необходимост от оперативна финансова видимост."],
  ["Финансови и регулирани компании", "За бизнеси, при които финансовото управление, контролът и рискът трябва да работят като свързана система."],
  ["Компании в трансформация", "За организации при внедряване на ERP, промяна на отчетността, преструктуриране или ускорен растеж."],
];
const related = [
