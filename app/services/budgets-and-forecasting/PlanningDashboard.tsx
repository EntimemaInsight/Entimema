  ...
  return (
    <div className={styles.dashboard} aria-label="Демонстрационно табло за финансово планиране">
      <div className={styles.dashboardTop}>
        <div><span className={styles.dashboardEyebrow}>Planning workspace</span><h2>Forecast Overview</h2></div>
      ...
      <div className={styles.charts}>
        <section className={styles.chartPanel} aria-labelledby="plan-chart-title">
          <div className={styles.chartHeading}>
            <div><span>Performance plan</span><h3 id="plan-chart-title">Actual vs Budget vs Forecast</h3></div>
        ...
        <section className={styles.cashPanel} aria-labelledby="cash-outlook-title">
          <div className={styles.chartHeading}><div><span>Liquidity plan</span><h3 id="cash-outlook-title">Cash Flow Outlook</h3></div></div>
        ...
        <section className={styles.chartPanel} aria-labelledby="scenario-title">
          ...
          <div className={styles.scenarioBars} aria-label="Сравнение между downside, base и upside сценарий">
        ...
        <section className={styles.cashPanel} aria-labelledby="drivers-title">
          <div className={styles.chartHeading}><div><span>Driver model</span><h3 id="drivers-title">Revenue Drivers</h3></div></div>
