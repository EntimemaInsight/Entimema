...
const capabilities = [
  ...
  ["Driver-based модели", "Планиране чрез конкретните фактори, които определят приходите, разходите и маржовете."],
      ...
      <section className={styles.section} aria-labelledby="outcomes-title"><div className="site-container">
        ...
        <aside className={styles.caseExample} aria-labelledby="case-example-title">
          ...
          <dl>
            ...
            <div><dt>Подход</dt><dd>Driver-based модел, свързващ обеми, капацитет, материали, цени, разходи и парични потоци, допълнен със сценарии и Rolling Forecast.</dd></div>
