    ...
    <main className={styles.page}>
      ...
      <section className={styles.hero} aria-labelledby="financial-data-title"><div className={`site-container ${styles.heroInner}`}>
        <div className={styles.heroCopy}>
          ...
          <DemoTrigger className={styles.primaryButton} initialInterest="Financial Data & ERP">Discuss your financial data foundation</DemoTrigger>
        </div>
