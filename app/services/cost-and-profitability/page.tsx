...
export default function CostAndProfitabilityPage() {
  return <main className={styles.page}>
    ...
    <section className={styles.ctaSection}><div className="site-container"><div className={styles.ctaBlock}><span>COST &amp; MARGIN MANAGEMENT</span><h2>You know the profit.<br />Now find out what created it.</h2><p>Build a cost and margin model that shows where value is created, where profitability is lost and what management can do about it.</p><DemoTrigger className={styles.ctaButton} initialInterest="Cost & Profitability" /></div></div></section>
  </main>;
}
