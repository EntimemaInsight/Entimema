  ...
  return <>
    ...
    <section id="resolve">
      ...
      <div className={styles.bridges}>
        <article><span>IMPLEMENTATION</span><h3>Diagnose before changing the model.</h3><p>Entimema Credit Risk connects performance evidence, portfolio change and governance to a proportionate intervention.</p><Link href="/services/credit-risk">Explore Credit Risk consulting </Link></article>
        <article><span>OPERATIONALISATION</span><h3>Make recurring diagnosis reproducible.</h3><p>A future PD Model Monitoring Agent could prepare signals, classifications and investigation routes for human review. It is a product direction, not a live-agent claim.</p><Link href="/agents">Explore the AI Agents Library </Link></article>
      </div>
