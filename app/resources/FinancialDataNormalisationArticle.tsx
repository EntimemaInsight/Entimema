...
export default function FinancialDataNormalisationArticle() {
  return <>
    ...
    <section id="resolve">
      ...
      <p>This normalised evidence becomes the input to <Link href="/resources/trial-balance-to-financial-statements">controlled trial-balance mapping</Link> and <Link href="/resources/financial-data-validation-control-layer">deterministic financial validation</Link>. Together, those methods operate within the complete <Link href="/resources/traceable-financial-analysis-workflow">traceable financial analysis workflow</Link>. Entimema’s <Link href="/services/financial-data">Financial Data service</Link> applies the same discipline to ERP, reporting and analytical foundations.</p>
      ...
      <DecisionImplication>Transform heterogeneous statements into a validated analytical structure. <Link href="/contact">Discuss the financial data context with Entimema</Link>.</DecisionImplication>
    </section>
  </>;
}
