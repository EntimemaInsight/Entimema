...
export const resources: ResourceRecord[] = [
  {
    ...
    relatedResourceSlugs: ["pd-model-ranking-calibration", "credit-vintage-analysis"],
    status: "published",
    indexable: true,
  ...
  },
  {
    ...
    relatedResourceSlugs: ["pd-model-monitoring", "operational-driver-forecasting"],
    status: "published",
    indexable: true,
  ...
  },
  {
    ...
    relatedCapability: { label: "Credit Risk", href: "/services/credit-risk", description: "Connect portfolio behaviour, models and policy evidence to controlled credit decisions." },
    relatedResourceSlugs: ["pd-model-monitoring", "high-gini-good-credit-decision", "credit-vintage-analysis"],
    status: "published",
    indexable: true,
