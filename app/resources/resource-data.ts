...
export const resources: ResourceRecord[] = [
  ...
  },
  {
    ...
    seoTitle: "Price Volume Mix Variance Analysis: Formulas | Entimema",
    metaDescription: "Calculate price, volume, mix, cost and efficiency variances, reconcile the variance bridge and turn budget-versus-actual movements into management action.",
  ...
  },
  {
    ...
    author: authors.aleksandar, publishedAt: "2026-08-19", updatedAt: "2026-08-19", readingMinutes: 54,
    topic: "credit-risk", stream: "insights", featured: true,
    seoTitle: "Champion Challenger Testing in Credit Risk | Entimema",
    metaDescription: "Test champion and challenger credit strategies through replay, decision migration, controlled deployment, mature vintages and economic attribution.",
  ...
  },
  {
    ...
    stream: "insights",
    featured: true,
    seoTitle: "Credit Score Scaling & PDO Formula | Entimema",
    metaDescription: "Derive credit score Factor and Offset from base odds and PDO, map scores to PD, calculate scorecard points and reconcile rounding and production cut-offs.",
