...
export const resources: ResourceRecord[] = [
  ...
  },
  {
    ...
    stream: "insights",
    featured: true,
    seoTitle: "Credit Score Scaling & Points to Double the Odds",
    metaDescription: "Credit score scaling and PDO: derive Factor and Offset, map odds to scores and PD, calculate scorecard points, reconcile rounding and production cut-offs.",
    canonicalPath: "/resources/score-scaling-points-to-double-odds-credit-scores",
    openGraphTitle: "Score Scaling & PDO: PD Models to Operational Credit Scores",
    openGraphDescription: "A practitioner framework for base score, base odds, PDO, variable points, score-to-PD mapping, rounding, cut-offs and production reconciliation.",
