...
export const resources: ResourceRecord[] = [
  {
    technicalTitle: "Default Definition for PD Models",
    headline: "Your PD Model Learns the Default You Define",
    headlineEmphasis: "Default You Define",
    slug: "pd-default-definition-target-construction",
    slogan: "Default criteria, materiality, scope, timing and cure logic construct the target—and determine the risk boundary a probability-of-default model can learn.",
    sloganEmphasis: "construct the target",
    ...
    stream: "insights",
    featured: false,
    seoTitle: "Default Definition for PD Models | Entimema",
    metaDescription: "How default criteria, DPD, unlikeliness to pay, borrower scope, cure and event timing construct the target used in probability-of-default models.",
    canonicalPath: "/resources/pd-default-definition-target-construction",
    openGraphTitle: "Your PD Model Learns the Default You Define",
    openGraphDescription: "Why default definition is part of the PD model—and how criteria, scope, timing and cure logic change the target it learns.",
