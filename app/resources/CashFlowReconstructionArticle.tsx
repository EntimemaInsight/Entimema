...
export default function CashFlowReconstructionArticle() {
  return <>
    ...
    <section id="execution">
      ...
      <p><Link href="/resources/financial-data-normalisation">FIR-01 normalisation</Link> makes inputs comparable; <Link href="/resources/financial-data-validation-control-layer">FIR-03 validation</Link> establishes fixed controls; <Link href="/resources/traceable-financial-analysis-workflow">FIR-05’s end-to-end workflow</Link> preserves evidence through review. Missing schedules should generate a bounded request for evidence and limit the affected conclusion, rather than produce a confident cash story.</p>
