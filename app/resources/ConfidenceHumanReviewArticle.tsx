...
export default function ConfidenceHumanReviewArticle() {
  return <>
    ...
    <section id="resolve">
      ...
      <p>This framework builds on FIR-01, <Link href="/resources/financial-data-normalisation">Financial Data Normalisation</Link>; FIR-02, <Link href="/resources/trial-balance-to-financial-statements">Trial Balance Mapping</Link>; and FIR-03, <Link href="/resources/financial-data-validation-control-layer">Financial Data Validation</Link>. It also connects to Entimema’s <Link href="/services/financial-data">Financial Data service</Link> and <Link href="/resources/from-erp-data-to-management-intelligence">ERP and management intelligence research</Link>.</p>
      <DecisionImplication>See how Entimema separates automated processing from material judgement. <Link href="/contact">Discuss a financial intelligence engagement</Link>.</DecisionImplication>
    </section>
  </>;
}
