...
export default function WorkingCapitalAnalysisArticle() {
  return <>
    ...
    <section id="execution">
      ...
      <p><Link href="/resources/horizontal-and-vertical-financial-analysis">Comparative analysis</Link> identifies structural movement; <Link href="/resources/working-capital-as-a-system">working capital as a system</Link> connects operating drivers; <Link href="/resources/operational-driver-forecasting">driver forecasting</Link> tests future funding. Here the opening contradiction resolves into 6.6 of working-capital absorption, concentrated collection risk, partly justified stock and a time-sensitive funding gap. A controlled 2.378082 opportunity deserves execution testing; an aggressive 6.564384 does not deserve automatic approval.</p>
