...
export default async function ResourcePage({ params }: PageProps<"/resources/[slug]">) {
  ...
  if (resource.slug === "financial-data-lineage") {
    return <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: serializeJsonLd(articleSchema) }} />
      <ResourceArticle resource={resource} sections={[...financialDataLineageSections]} readingMinutes={calculateReadingMinutes("FinancialDataLineageArticle.tsx")}>
        <FinancialDataLineageArticle />
      </ResourceArticle>
    </>;
  }
  ...
  if (resource.slug === "profit-vs-cash-flow-reconstruction") {
    return <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: serializeJsonLd(articleSchema) }} />
      <ResourceArticle resource={resource} sections={[...cashFlowReconstructionSections]} readingMinutes={calculateReadingMinutes("CashFlowReconstructionArticle.tsx")}>
        <CashFlowReconstructionArticle />
      </ResourceArticle>
    </>;
  }
  ...
  if (resource.slug === "variance-analysis-price-volume-mix-cost-drivers") {
    return <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: serializeJsonLd(articleSchema) }} />
      <ResourceArticle resource={resource} sections={[...varianceAnalysisSections]} readingMinutes={calculateReadingMinutes("VarianceAnalysisArticle.tsx")}>
        <VarianceAnalysisArticle />
      </ResourceArticle>
    </>;
  }
