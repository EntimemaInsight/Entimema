  ...
  return <>
    ...
    <section id="operationalise">
      ...
      <div className={styles.bridgeGrid}>
        <article><span>IMPLEMENTATION</span><h3>Build the monitoring architecture around the decision.</h3><p>Entimema Credit Risk connects model evidence, portfolio behaviour, policy and governance into an operational monitoring system.</p><Link href="/services/credit-risk">Explore Credit Risk consulting </Link></article>
        <article><span>OPERATIONALISATION</span><h3>From recurring signals to repeatable workflows.</h3><p>A future PD Model Monitoring Agent could prepare calculations, exceptions, history and investigation pathways for human review. This is a product direction, not a claim of a currently launched agent.</p><Link href="/agents">Explore the AI Agents Library </Link></article>
      </div>
