...
export default function TrialBalanceMappingArticle() {
  return <>
    ...
    <section id="resolve">
      ...
      <p>This framework extends <Link href="/resources/financial-data-normalisation">financial data normalisation</Link> into account-level translation. Its mappings feed <Link href="/resources/financial-data-validation-control-layer">financial validation controls</Link>; material ambiguity is routed through <Link href="/resources/confidence-human-review-ai-finance">confidence and human review</Link>; and the combined method sits within the <Link href="/resources/traceable-financial-analysis-workflow">traceable end-to-end financial analysis workflow</Link>. Entimema’s <Link href="/services/financial-data">Financial Data service</Link> provides the corresponding service context.</p>
      ...
      <DecisionImplication>Test a trial balance against a controlled financial structure. <Link href="/contact">Discuss the mapping requirements with Entimema</Link>.</DecisionImplication>
    </section>
  </>;
}
