...
export default function TraceableFinancialAnalysisWorkflowArticle() {
  return <>
    ...
    <section id="workflow">
      ...
      <p>The reviewer receives the affected value, source evidence, proposed interpretation, alternatives, failed or missing controls, materiality, downstream consequence and a targeted question. The review resolves the smallest material uncertainty rather than reproducing the full workflow manually. Its decision records authority, rationale and scope; deterministic controls then rerun. <Link href="/resources/confidence-human-review-ai-finance">FIR-04</Link> details this exception architecture.</p>
    ...
    <section id="resolve">
      ...
      <p><Link href="/resources/financial-data-normalisation">FIR-01</Link> establishes comparable meaning, <Link href="/resources/trial-balance-to-financial-statements">FIR-02</Link> governs canonical mapping, <Link href="/resources/financial-data-validation-control-layer">FIR-03</Link> proves fixed relationships and <Link href="/resources/confidence-human-review-ai-finance">FIR-04</Link> routes material uncertainty. FIR-05 composes them into one operating architecture whose result can be inspected, challenged and repeated.</p>
