...
export default function VarianceAnalysisArticle() {
  return <>
    ...
    <section id="execution">
      ...
      <p><Link href="/resources/financial-data-validation-control-layer">Financial data validation</Link> establishes admissible evidence; the <Link href="/resources/traceable-financial-analysis-workflow">end-to-end workflow</Link> preserves its lineage. <Link href="/resources/horizontal-and-vertical-financial-analysis">Horizontal and vertical analysis</Link> locates performance movement. <Link href="/resources/operational-driver-forecasting">Operational-driver forecasting</Link> carries tested assumptions forward, while <Link href="/resources/building-a-manufacturing-cost-architecture">manufacturing cost architecture</Link> defines the cost perimeter.</p>
