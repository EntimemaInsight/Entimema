...
export default function VarianceAnalysisArticle() {
  return <>
    <p className={styles.leadParagraph}><strong>Price-volume-mix analysis decomposes the change between baseline and actual revenue into activity, portfolio mix and realised price effects.</strong> A controlled variance bridge then extends the same logic to cost, efficiency and capacity, and reconciles every driver back to the reported financial result.</p>
    <p>Revenue is EUR 361,000 above budget, yet the core product has lost EUR 44,000 through realised price deterioration. Material cost is EUR 51,500 above the standard requirement for actual output. EBITDA is close to plan. The report concludes that commercial strength compensated for manufacturing overspend. The totals are correct; the explanation is premature.</p>
