...
export default function ProductExplainer() {
  ...
  return <section id="how-it-works" className={styles.explainer} aria-labelledby="explainer-title">
    ...
    <nav className={styles.explainerActions} aria-label="Explainer next steps"><FinancialIntelligenceCta href="#pilot-checkout" kind="start_pilot" position="explainer">Start the pilot</FinancialIntelligenceCta><FinancialIntelligenceCta href="#old-condition" kind="architecture" position="explainer">Explore the architecture</FinancialIntelligenceCta></nav>
  </section>;
}
