...
Metadata now passes: income_statement, CHF, millions, periods 2024/2025. The full response is retained in [live evidence](./RIETER_REAL_FILE_ACCEPTANCE.json). The earlier currency failure remains in [pre-normalization evidence](./RIETER_REAL_FILE_ACCEPTANCE_PRE_NORMALIZATION.json).
