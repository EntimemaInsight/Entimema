const services = [
  ...
  { number: "02", title: "УПРАВЛЕНИЕ НА РИСКА", description: "Рискът трябва да бъде измерим." },
      ...
      <div className="site-container hero__layout">
        <div className="hero__copy">
          ...
          <p className="hero__description">
            Най-силните организации не управляват отделни функции. Те управляват взаимосвързани системи. Финансите, управлението на риска, данните и технологиите създават стойност, когато работят като една управленска архитектура.
          </p>
        </div>
