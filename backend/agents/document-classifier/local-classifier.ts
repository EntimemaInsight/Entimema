...
const RULES: Rule[] = [
  ...
  { type: "Accounts Payable Aging", family: "Accounting", requiredGroups: [["vendor", "supplier"], ["invoice", "document number"], ["due date", "days overdue", "aging bucket"], ["amount", "balance"]], optional: ["currency", "posting date", "payables", "current", "past due"], base: 0.93 },
  { type: "Purchase Invoice", family: "Accounting", requiredGroups: [["vendor", "supplier"], ["invoice number", "invoice no"], ["invoice date"], ["purchase order", "po number"]], optional: ["net amount", "vat", "tax amount", "gross amount", "currency"], base: 0.93 },
  { type: "Invoice Register", family: "Accounting", requiredGroups: [["invoice number", "invoice no"], ["invoice date"], ["net amount", "invoice amount"], ["vat", "tax amount", "gross amount"]], optional: ["vendor", "customer", "currency", "register"], base: 0.93 },
  { type: "Budget", family: "Finance", requiredGroups: [["budget"], ["fiscal year", "period"], ["department", "cost center"], ["budget amount", "planned amount"]], optional: ["actual", "variance", "approved", "annual budget"], base: 0.94 },
  { type: "Forecast", family: "Finance", requiredGroups: [["forecast"], ["forecast period", "horizon"], ["scenario", "assumption"], ["forecast amount", "projected amount"]], optional: ["actual", "variance", "rolling forecast", "base case"], base: 0.94 },
  { type: "Management Report", family: "Finance", requiredGroups: [["management report"], ["kpi", "key performance indicator"], ["actual"], ["target", "variance"]], optional: ["commentary", "executive summary", "performance", "dashboard"], base: 0.94 },
  { type: "Loan Agreement", family: "Legal", requiredGroups: [["loan agreement", "facility agreement"], ["borrower"], ["lender"], ["interest rate", "maturity date"]], optional: ["repayment", "covenant", "principal", "facility amount"], base: 0.94 },
  { type: "Contract", family: "Legal", requiredGroups: [["contract", "agreement"], ["effective date"], ["parties"], ["termination", "governing law", "obligations"]], optional: ["term", "signature", "confidentiality", "services"], base: 0.93 },  { type: "Financial Statements", family: "Finance", requiredGroups: [["revenue", "sales"], ["gross profit", "operating profit", "ebitda", "net income", "net profit"], ["assets", "total assets"], ["liabilities", "equity", "total equity"]], optional: ["cash", "inventory", "receivables", "cost of sales", "income statement", "balance sheet", "p&l", "profit and loss"], base: 0.95 },
];
