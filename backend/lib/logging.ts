...
export type AgentLog = { run_id: string; actor_id?: string; agent: "document_classifier"; event: string; file_type?: string; file_size?: number; document_family?: string | null; document_type?: string | null; confidence?: number; classification_source?: ClassificationSource; openai_call_count?: number; routing_result?: string; timing?: Timing; duration_ms?: number; error_code?: string };
