export const ERROR_CODES = ["FILE_MISSING", "FILE_TOO_LARGE", "UNSUPPORTED_FILE_TYPE", "FILE_CORRUPT", "FILE_ENCRYPTED", "OPENAI_TIMEOUT", "OPENAI_RATE_LIMIT", "OPENAI_RESPONSE_INVALID", "CLASSIFICATION_FAILED", "INTERNAL_ERROR"] as const;
...
const messages: Record<ErrorCode, string> = {
  ...
  FILE_ENCRYPTED: "Encrypted or password-protected files are not supported.", OPENAI_TIMEOUT: "Document classification timed out.",
